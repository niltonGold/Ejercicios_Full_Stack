import { retrieveTVByBrandAndInches, createTV, retrieveTVById, retrieveTVByModel } from "./tv.model.js";
...
export async function getTVsCtrl(req, res) {
    ...
    const tvs = await retrieveTVByBrandAndInches(brand, parseInt(inches));
    res.json(tvs);
}
